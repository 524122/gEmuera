...
| 旧可运行 gEmuera `E:/MyCode/GodotCode/gEmuera-future` | 存在 project.godot、csproj、export preset；实际声明 Godot.NET.Sdk 4.7.0、桌面 net8、Android net9、Compatibility/OpenGL ES 3 renderer、Android preset | 迁移起点与 legacy fixture runner |
