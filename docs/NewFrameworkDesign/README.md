...
11. [RenderingSystem](RenderingSystem.md)、[RendererDeploymentPolicy](RendererDeploymentPolicy.md)、[AudioSystem](AudioSystem.md)、[LifecycleMemory](LifecycleMemory.md)：Godot 表现与资源。
...
| 资源/HTML/渲染/音频 | ResourceSystem、MarkupSystem、RenderingSystem、RendererDeploymentPolicy、AudioSystem |
