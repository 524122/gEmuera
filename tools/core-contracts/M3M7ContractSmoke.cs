...
internal static class M3M7ContractSmoke
{
    ...
    private static async Task CooperativeContractAsync()
    {
        ...
        var identity = new M6ExperimentIdentity(
            ...
            M6FeatureFlags.Default with { Scheduler = true });
        ...
        var definition = new M6ExperimentDefinition(identity, "smoke", "baseline", "rollback", new M6PerformanceThresholds(10, 20, 1000, 10), audit);
