...
try {
    ...
    if ($baseConfig.profile -notin @('v24pure', 'snake')) {
        throw 'Profile must be v24pure or snake.'
    }
    ...
    if ($inProcessSessionCycle -ieq 'cross-aba') {
        ...
        if ($alternateSession.profile -notin @('v24pure', 'snake')) {
            throw 'cross-aba alternate session profile must be v24pure or snake.'
        }
