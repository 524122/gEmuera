...
*文档版本: 2026-06-06（更新：版本历史、模型 ID、研究预览背景）*
*基于 Claude Code 2.1.167 系统提示词与官方 Changelog 整理*

### 版本历史补充

| 版本 | 日期 | 关键变更 |
|------|------|---------|
| 2.1.154 | 2026-05-28 | Dynamic Workflow 以研究预览发布 |
| 2.1.157 | 2026-05-29 | worktree 隔离模式 |
| 2.1.160 | 2026-06-02 | 触发词从 'workflow' 改为 'ultracode' |
| 2.1.167 | 2026-06-06 | 当前版本 |
