...
3. [DialectExtensionSystem](DialectExtensionSystem.md)、[DirectoryCompatibilityRouting](DirectoryCompatibilityRouting.md)：v24、Snake 与未来魔改解释器的组合、隔离、扩展契约，以及不依赖内容探测的 `compat/<profile>/<game>` 目录路由设计。
